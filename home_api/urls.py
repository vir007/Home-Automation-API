...
urlpatterns = [
    ...
    # # Home Routes
    # path('home', HomeList.as_view(), name='home_list_create'),
    # path('home/<int:home_id>/', HomeDetail.as_view(), name='home_detail_update'),
    
    # # Room Routes
    # path('rooms', RoomList.as_view(), name='room_list_create'),
    # path('rooms/<int:room_id>/', RoomDetail.as_view(), name='room_detail_update'),
    # path('home/<int:home_id>/<int:room_id>/', RoomDetail.as_view(), name='room_detail_update'),
    ...
    # path('home/<int:home_id>/<int:room_id>/<int:light_id>/', LightsDetail.as_view(), name='light_room_detail_update'),
