...
urlpatterns = [
    ...
    # Log Tables Route
    path('loglights', LogLightsList.as_view(), name='log_light_list_create'),
    path('logthermostat', LogThermostatList.as_view(), name='log_thermostat_list_create'),
    path('logroomtemp', LogRoomTempList.as_view(), name='log_room_temp_list_create'),
