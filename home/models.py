...
class Room(models.Model):
    name = models.CharField(max_length=100)
    home = models.ForeignKey(Home, related_name='room', on_delete=models.CASCADE)
...
class Log_thermostat(models.Model):
    home = models.ForeignKey(Home,related_name='home_thermostate',on_delete=models.CASCADE)
...
class Log_lights(models.Model):
    lights = models.ForeignKey(Lights,related_name='lights_log',on_delete=models.CASCADE)
    oldVal = models.CharField(max_length=100)
    newVal = models.CharField(max_length=100)
    created_on = models.DateTimeField(auto_now = True)
...
class Log_room_temp(models.Model):
    room = models.ForeignKey(Room,related_name='room_temp', on_delete=models.CASCADE)
    oldVal = models.CharField(max_length=100)
    newVal = models.CharField(max_length=100)
    created_on = models.DateTimeField(auto_now = True)
